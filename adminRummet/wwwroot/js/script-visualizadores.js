...
/*Visualizadores de los contratos*/
...
function validarExt8() {
  ...
  if (archivoInput8.files && archivoInput8.files[0]) {
    var visor = new FileReader();
    visor.onload = function (e) {
      document.getElementById("visorArchivo2").innerHTML =
        '<div class="juanito_8" id="id_8"> <embed id="visualizador" src="' +
        e.target.result +
        '" width="270px" height="400px" /> </div>';

        auxiliar8= e.target.result;
        
    };
    visor.readAsDataURL(archivoInput8.files[0]);
  }
}
//Visor 8
function visorExt8() {
  ...
  if (archivoInput8.files && archivoInput8.files[0]) {
    ...
    visor.onload = function (e) {
      document.getElementById("visorArchivo2").innerHTML =
        '<div class="juanito_8" id="id_8"> <embed id="visualizador" src="' + auxiliar8 +
        '" width="270px" height="400px" /> </div>';
